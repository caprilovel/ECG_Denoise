#!/bin/bash
# python main.py --model_index  0  --noise_type_index 0
# python main.py --model_index  0  --noise_type_index 1
# python main.py --model_index  0  --noise_type_index 2
# python main.py --model_index  0  --noise_type_index 3

# python main.py --model_index  0  --noise_type_index 3 --intensity_index 0
# python main.py --model_index  0  --noise_type_index 3 --intensity_index 1
# python main.py --model_index  0  --noise_type_index 3 --intensity_index 2
# python main.py --model_index  0  --noise_type_index 3 --intensity_index 3
...
# python main.py --model_index  1  --noise_type_index 3

# python main.py --model_index  1  --noise_type_index 3 --intensity_index 0
# python main.py --model_index  1  --noise_type_index 3 --intensity_index 1
...
# python main.py --model_index  2  --noise_type_index 1
# python main.py --model_index  2  --noise_type_index 2
# python main.py --model_index  2  --noise_type_index 3

# python main.py --model_index  2  --noise_type_index 3 --intensity_index 0
# python main.py --model_index  2  --noise_type_index 3 --intensity_index 1
# python main.py --model_index  2  --noise_type_index 3 --intensity_index 2
# python main.py --model_index  2  --noise_type_index 3 --intensity_index 3
...
# python main.py --model_index  4  --noise_type_index 1
